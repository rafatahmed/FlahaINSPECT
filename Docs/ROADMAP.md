...
**Current release in progress:** **R0 complete** → next is **R1** starting at PR-01.
...
|----|-----|-----------|------|--------|-----------|
| R1-01 | PR-01 | Monorepo scaffold, CI skeleton, Flutter sibling | R0 | `not-started` | `apps/api|web|worker|mobile` exist; pnpm turbo for Node; mobile documented as sibling; CI lint/test placeholders green |
