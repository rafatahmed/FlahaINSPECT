...
**Current release in progress:** **R1** (branch `feat/pr-08-sync-delta`). R0 tag: `r0-design-freeze`. R1-01–R1-07 merged.
...
| R1-08 | PR-08 | Keyset delta freeze | R1-06, R1-07 | `in-progress` | KD-38; OpenAPI frozen for mobile; `PROJECT_ARCHIVED` |
